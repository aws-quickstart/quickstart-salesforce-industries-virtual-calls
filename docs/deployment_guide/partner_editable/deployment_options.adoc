...
To upgrade {partner-product-short-name} resources in an existing AWS account, refer to link:#_upgrade-an-existing-deployment-of-partner-product-short-name[Upgrade an existing deployment of {partner-product-short-name}] for details. 
