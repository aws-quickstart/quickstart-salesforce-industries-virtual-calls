...
To upgrade {partner-product-short-name} resources in an existing AWS account, refer to link:#_upgrade_an_existing_deployment_of_Virtual_Calls[Upgrade an existing deployment of {partner-product-short-name}] for details. 
